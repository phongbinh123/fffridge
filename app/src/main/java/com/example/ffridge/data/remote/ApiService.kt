...
interface ApiService {
    ...
    // 2. Lấy thông tin qua Tên (Nhập tay) - Endpoint Search
    @GET("https://nutritionix-api.p.rapidapi.com/v1_1/search/{query}")
    suspend fun searchFoodByName(
        @Path("query") query: String,
        @Query("fields") fields: String = "item_name,nf_calories,nf_serving_size_qty,nf_serving_size_unit,photo", // Lấy các trường cần thiết
        @Header("X-RapidAPI-Key") apiKey: String = "fc6fbf058emsh24e3e2cb5fcda03p12ffd1jsn451c757b8d26",
        @Header("X-RapidAPI-Host") host: String = "nutritionix-api.p.rapidapi.com"
    ): Response<NutritionixSearchResponse>
